...
This book will help you to create working and valuable code, quickly.
...
You can follow along with the coding and together we’ll build a fullstack application while applying the philosophy of rapid development. There’ll be plenty of simple examples, but we are also working towards a non-trivial example application called _Photosphere_.
...
In the coming chapters we’ll implement our philosophy, create our development process and get into coding.
...
In the chapters between building Photosphere we look at automated testing in Chapter 5 and debugging  in Chapter 6. 
